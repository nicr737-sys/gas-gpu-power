        ...
        <div className="flex items-start gap-3 p-4 rounded-lg bg-muted/50 border border-border mb-6">
          ...
          <div className="text-sm text-muted-foreground">
            ...
            <p className="break-words">
              Утилитарные цифровые права (УЦП) «Инфраструктурный Энерго-Юнит» (IEU) не являются банковским вкладом 
              и не застрахованы по ФЗ-177 «О страховании вкладов физических лиц в банках Российской Федерации».
              Токен закрепляет право требования комплексной услуги по размещению и обеспечению работы 
              вычислительного оборудования. Инвестиционные риски несёт приобретатель.
