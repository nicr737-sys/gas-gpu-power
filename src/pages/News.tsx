...
const News = () => {
  const newsItems = [
    ...
    {
      date: "2025-03-01",
      title: "Подготовка документов для выпуска УЦП/ГЦП",
    ...
    },
    {
      ...
      excerpt: "Проводится анализ операторов ОИС из реестра Банка России для выбора оптимальной платформы для выпуска УЦП/ГЦП.",
