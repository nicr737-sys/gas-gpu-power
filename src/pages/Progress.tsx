            ...
            {photos.map((photo, index) => (
              <Card key={index} className="card-hover overflow-hidden">
                <CardContent className="p-4">
                  ...
                  />
                  <p className="text-sm text-muted-foreground mt-2 text-center break-words">
                    {photo.alt}
                  </p>
                </CardContent>
              </Card>
            ...
            <CardContent className="space-y-6">
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <ul className="space-y-2 text-sm text-muted-foreground ml-0 sm:ml-4">
                    <li className="break-words"><strong>Безопасность и связь:</strong> Развертывание системы видеонаблюдения, подключение высокоскоростного интернета и установка охранных комплексов (тревожная кнопка).</li>
