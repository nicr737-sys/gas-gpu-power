    ...
    <div className="min-h-screen py-20">
      <div className="container mx-auto px-4">
        <div className="text-center mb-16 animate-fade-in">
          <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold mb-4 text-gradient break-words">
            Реализация проекта
          </h1>
        ...
        <div className="mb-16">
          <h2 className="text-2xl sm:text-3xl font-bold text-center mb-2 break-words flex items-center justify-center gap-3">
            <Container className="w-7 h-7 text-energy" />
            Готовим места для энергоконтейнеров
          </h2>
          <p className="text-center text-muted-foreground mb-8 max-w-2xl mx-auto">
            Подготовка площадок и размещение оборудования для энергетических модулей — февраль 2026
          </p>

          <div className="grid sm:grid-cols-2 gap-6 max-w-3xl mx-auto">
            {[
              { src: energyContainer1, alt: "Блок энергоконтейнеров" },
              { src: energyContainer2, alt: "Подготовка мест для установки" },
            ].map((photo, index) => (
              <Card key={index} className="card-hover overflow-hidden">
                <CardContent className="p-4">
                  <img src={photo.src} alt={photo.alt} className="w-full h-48 object-cover rounded-lg" />
                  <p className="text-sm text-muted-foreground mt-2 text-center break-words">{photo.alt}</p>
                </CardContent>
              </Card>
            ))}
          </div>
        ...
        <div className="mb-16">
          <h2 className="text-2xl sm:text-3xl font-bold text-center mb-2 break-words flex items-center justify-center gap-3">
            <Flame className="w-7 h-7 text-energy" />
            Прокладка газа уже началась!
          </h2>
          <p className="text-center text-muted-foreground mb-8 max-w-2xl mx-auto">
            Активная фаза строительства газовой инфраструктуры на площадке — февраль 2026
          </p>

          <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-6">
            {[
              { src: gasLaying1, alt: "Монтаж газовых труб на площадке" },
              { src: gasLaying2, alt: "Подготовка газовой обвязки и трубопроводов" },
              { src: gasLaying3, alt: "Земляные работы для прокладки газопровода" },
            ].map((photo, index) => (
              <Card key={index} className="card-hover overflow-hidden">
                <CardContent className="p-4">
                  <img src={photo.src} alt={photo.alt} className="w-full h-48 object-cover rounded-lg" />
          ...
          <div className="mt-8 flex justify-center">
            <div className="w-full max-w-3xl aspect-video rounded-lg overflow-hidden">
              <iframe
                width="100%"
                height="100%"
                src="https://rutube.ru/play/embed/1e20f8d3b6f99bafcc48b3207cfab7f1"
          ...
          <Card className="card-elevated">
            <CardHeader>
              ...
              <CardDescription className="mt-2 break-words">
                В представленной модели отражен первый этап развертывания — подключение 17 автономных энергетических модулей.
                Все финансовые расчеты и сроки приведены в рамках этого этапа. В перспективе планируется развертывание до 37 модулей.
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-6">
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground mb-3 break-words">Период активных капитальных вложений и строительства.</p>
                  <p className="text-sm text-muted-foreground ml-0 sm:ml-4 mb-2 break-words">
                    <strong>Моторокомплекты:</strong> Начало платежей за поставку энергетического оборудования. Общая сумма инвестиций в агрегаты составляет 320 000 000 руб.
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground mb-3 break-words">Активная фаза работ на площадке.</p>
                  <ul className="space-y-2 text-sm text-muted-foreground ml-0 sm:ml-4">
                    <li className="break-words"><strong>Благоустройство:</strong> Установка ограждения (2 млн руб.), ворот и планировка территории (2,9 млн руб.).</li>
                    <li className="break-words"><strong>Внешние сети:</strong> Оплата этапов технологического присоединения газа согласно графику договора.</li>
                  </ul>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="font-semibold text-lg mb-1">Апрель – май 2026 — СМР и газовая обвязка</h3>
                  <p className="text-muted-foreground mb-3 break-words">Самый ответственный технический этап строительства.</p>
                  <ul className="space-y-2 text-sm text-muted-foreground ml-0 sm:ml-4">
                    <li className="break-words"><strong>Инженерная инфраструктура:</strong> Монтаж системы газовой обвязки — создание "кровеносной системы" энергоцентра.</li>
                    <li className="break-words"><strong>Здания и сооружения:</strong> Возведение складских помещений, бытовых корпусов для персонала и обслуживания оборудования.</li>
                  </ul>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <ul className="space-y-2 text-sm text-muted-foreground ml-0 sm:ml-4">
                    ...
                    <li className="break-words"><strong>Готовность:</strong> Завершение всех капитальных оплат и строительных работ. Старт генерации электроэнергии для обеспечения работы 17 автономных энергетических модулей.</li>
                  </ul>
                </div>
              </div>
            </CardContent>
        ...
        <div className="mb-12">
          ...
          <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-6 mb-12">
            <Card className="card-hover">
              <CardHeader><CardTitle className="text-lg">Локация</CardTitle></CardHeader>
              <CardContent>
                <div className="flex items-start gap-2">
                  <MapPin className="w-5 h-5 text-energy flex-shrink-0 mt-1" />
                  <p className="text-sm text-muted-foreground break-words">Республика Марий Эл, Медведевский район, пгт. Медведево (промышленная зона)</p>
                </div>
              </CardContent>
            </Card>
            <Card className="card-hover">
              <CardHeader><CardTitle className="text-lg">Площадь</CardTitle></CardHeader>
              <CardContent>
                <p className="text-2xl sm:text-3xl font-bold text-energy">16 320 м²</p>
                <p className="text-sm text-muted-foreground mt-2 break-words">Земли населенных пунктов для производственных нужд</p>
              </CardContent>
            </Card>
            <Card className="card-hover">
              <CardHeader><CardTitle className="text-lg">Оборудование</CardTitle></CardHeader>
              <CardContent>
                <p className="text-2xl sm:text-3xl font-bold text-energy">400+ единиц</p>
                <p className="text-sm text-muted-foreground mt-2 break-words">Вычислительное оборудование размещено и готово к интеграции</p>
              </CardContent>
            </Card>
          </div>
        </div>
        ...
        <Card className="mt-16 bg-gradient-to-br from-energy/10 to-transparent border-energy/20">
          <CardHeader>
            <CardTitle className="text-xl sm:text-2xl">Инвестиционная привлекательность</CardTitle>
          </CardHeader>
          <CardContent className="space-y-4">
            ...
            <div className="grid sm:grid-cols-3 gap-4 pt-4">
              <div className="text-center p-4 bg-background/50 rounded-lg">
                <p className="text-xl sm:text-2xl font-bold text-energy mb-1">40 МВт</p>
                <p className="text-sm text-muted-foreground">Планируемая мощность ГПУ</p>
              </div>
              <div className="text-center p-4 bg-background/50 rounded-lg">
                <p className="text-xl sm:text-2xl font-bold text-energy mb-1">10 лет</p>
                <p className="text-sm text-muted-foreground">Гарантированная аренда участка</p>
              </div>
              <div className="text-center p-4 bg-background/50 rounded-lg">
                <p className="text-xl sm:text-2xl font-bold text-energy mb-1">2026</p>
