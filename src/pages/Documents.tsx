...
const Documents = () => {
  const documents = [
    ...
    },
    {
      ...
      description: "Правила и регламенты работы оператора информационной системы, через которую осуществляется выпуск и обращение УЦП.",
      size: "—",
      available: true,
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-sm text-muted-foreground mb-3">
                      Официальный реестр операторов ОИС для выпуска и обращения цифровых прав.
                    </p>
              ...
              <Card className="p-6 bg-card border-border shadow-[var(--shadow-card)]">
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-sm text-muted-foreground mb-3">
                      Федеральный закон, регулирующий выпуск, обращение и погашение цифровых прав в Российской Федерации.
                    </p>
                    <Button variant="hero" size="sm" asChild>
