            ...
            <div className="space-y-8">
              ...
              <Card className="p-6 bg-card border-border shadow-[var(--shadow-card)]">
                ...
                <div className="pl-14 space-y-3 text-muted-foreground">
                  ...
                  <div className="mt-4">
                    <Button asChild size="sm" className="bg-energy text-white hover:bg-transparent hover:text-energy hover:border-energy border border-transparent transition-colors">
