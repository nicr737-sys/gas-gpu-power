              ...
              <Card className="p-6 bg-card border-border shadow-[var(--shadow-card)]">
                ...
                <div className="pl-0 sm:pl-14 space-y-3 text-muted-foreground">
                  ...
                  <div>
                    ...
                    <p className="ml-0 sm:ml-4 break-words">
                  ...
                  <p className="break-words">
                    ...
                    мероприятий по подключению и пуску газа — март-апрель 2026.
                  </p>
                  <div className="mt-4">
                    <Button asChild size="sm" className="bg-energy text-black hover:bg-transparent hover:text-energy hover:border-energy border border-transparent transition-colors">
              ...
              <Card className="p-6 bg-card border-border shadow-[var(--shadow-card)]">
                ...
                <ul className="space-y-2 text-muted-foreground">
                  <li className="flex items-start gap-2">
                    ...
                    5 газопоршневых установок (ГПУ)
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-energy mt-1">•</span>
                    Газопоршневой двигатель WEICHAI WP 13 D317E300NG
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-energy mt-1">•</span>
                ...
                <div className="grid sm:grid-cols-2 gap-x-8 gap-y-4">
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <div className="font-bold text-lg">200 кВт</div>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <div className="font-bold">WEICHAI WP 13 D317E300NG</div>
                    </div>
                  </div>
